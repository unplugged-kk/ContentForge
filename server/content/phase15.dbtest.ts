...
describeDb("phase 1.5 hardening (db)", () => {
  ...
  after(async () => {
    ...
    // of THIS file's voices/templates directly — a global `policyKey like
    // 'pol:%'` sweep raced other dbtest files' still-live generation_jobs
    // rows referencing shared (content-addressed) policies.
